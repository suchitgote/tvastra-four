            ...
            console.log("user",user);
               ...
               var isdoctor = req.session.isdoctor ;
                ...
                if(isdoctor){
                    ...
                    if(req.session.update_data){
                        res.render("demodoc", data = { user: req.session.update_data , doctors :user,noofuser:noofuser ,pagenoselected:pageno ,all_doc_check : all_doc_check ,emp : emp  , sortby:sortby  ,err:isdoctor });
                    }else{
                        res.render("demodoc", data = { user: req.session.userid.user , doctors :user,noofuser:noofuser ,pagenoselected:pageno,all_doc_check : all_doc_check ,emp : emp  , sortby:sortby  ,err:isdoctor });
                    }
                }else{
                    if(req.session.update_data){
                        res.render("demodoc", data = { user: req.session.update_data , doctors :user,noofuser:noofuser ,pagenoselected:pageno,all_doc_check : all_doc_check ,emp : emp  , sortby:sortby });
                    }else{
                        res.render("demodoc", data = { user: req.session.userid.user , doctors :user,noofuser:noofuser ,pagenoselected:pageno ,all_doc_check : all_doc_check ,emp : emp  , sortby:sortby });
                    }
                }
        })
        .catch(err=>{
    ...
    if(req.query.objindex && req.session.update_data){
        ...
        if(req.session.userid.user.type == "admin"){
            ...
            var obj = {
                ...
                scheduleid:req.session.userid.user.appointments[i].scheduleid,
                slotid:req.session.userid.user.appointments[i].slotid,
            }
        }
        console.log("...........................obj ",obj ) ;
...
const updatereschedule = (req,res)=>{
    ...
    .then(user => {
        ...
        models.user_schema.findOne({ _id :  doctorid })
